...
*/
$config['tables']['users']           = 'fokus_admin';
$config['tables']['groups']          = 'groups';
// $config['tables']['users_groups']    = 'user_groups';
$config['tables']['users_groups']    = 'fokus_group';
$config['tables']['login_attempts']  = 'fokus_login_attempts';
 ...
 */
$config['site_title']                 = "Template Metronic";       // Site Title, example.com
$config['user_email']                 = "template.metronic@gmail.com"; // Admin Email, admin@example.com
// $config['default_group']              = 'members';           // Default group, use name
$config['default_group']              = 'Penulis';           // Default group, use name
// $config['admin_group']                = 'admin';             // Default administrators group, use name
$config['admin_group']                = 'Superadmin';             // Default administrators group, use name
$config['identity']                   = 'admin_email';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes

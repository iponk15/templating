    ...
    t.fn.mDatatable = function(a) {
        if (0 !== t(this).length) {
            ...
            var o = {
                ...
                init: function(e) {
                    var a = !1;
                    return null === e.data.source && (o.extractTable(), a = !0), o.setupBaseDOM.call(), o.setupDOM(n.table), o.spinnerCallback(!0), o.setDataSourceQuery(o.getOption("data.source.read.params.query")), t(n).on("m-datatable--on-layout-updated", o.afterRender), n.debug && o.stateRemove(o.stateId), t.each(o.getOption("extensions"), function(e, a) {
                        "function" == typeof t.fn.mDatatable[e] && new t.fn.mDatatable[e](n, a)
                        ...
                        o.getOption("search.onEnter") && 13 !== e.which || o.search(t(this).val())
                    }), n
                },
                ...
                layoutUpdate: function() {
                    o.setupSubDatatable.call(), o.setupSystemColumn.call(), o.setupHover.call(), void 0 === a.detail && 1 === o.getDepth() && o.lockTable.call(), o.columnHide.call(), o.resetScroll(), o.isInit || (t(n).trigger("m-datatable--on-init", {
                        table: t(n.wrap).attr("id"),
                        options: a
                    }), o.isInit = !0), t(n).trigger("m-datatable--on-layout-updated", {
                        table: t(n.wrap).attr("id")
                    })
                },
                lockTable: function() {
                    var e = {
                        lockEnabled: !1,
                        init: function() {
                            e.lockEnabled = o.lockEnabledColumns(), 0 === e.lockEnabled.left.length && 0 === e.lockEnabled.right.length || e.enable()
                        },
                        enable: function() {
                ...
                fullRender: function() {
                    o.isLocked() && (t(n.tableHead).empty(), o.setHeadTitle(), o.getOption("layout.footer") && (t(n.tableFoot).empty(), o.setHeadTitle(n.tableFoot)), o.spinnerCallback(!0), t(n.wrap).removeClass("m-datatable--loaded"), o.insertData())
                },
                lockEnabledColumns: function() {
                    ...
                    return t.each(o, function(t, a) {
                        void 0 !== a.locked && (void 0 !== a.locked.left && e.getBreakpoint(a.locked.left) <= n && i.left.push(a.locked.left), void 0 !== a.locked.right && e.getBreakpoint(a.locked.right) <= n && i.right.push(a.locked.right))
                    }), i
                },
                afterRender: function(e, a) {
                    a.table == t(n.wrap).attr("id") && t(n).ready(function() {
                        o.isLocked() || (o.redraw(), o.getOption("rows.autoHide") && (o.autoHide(), t(n.table).find(".m-datatable__row").css("height", ""))), o.rowEvenOdd.call(), o.isLocked() && o.redraw(), t(n.tableBody).css("visibility", ""), t(n.wrap).addClass("m-datatable--loaded"), o.sorting.call(), o.scrollbar.call(), o.spinnerCallback(!1)
                    })
                },
                hoverTimer: 0,
                isScrolling: !1,
                setupHover: function() {
                    t(window).scroll(function(t) {
                        clearTimeout(o.hoverTimer), o.isScrolling = !0
                    }), t(n.tableBody).find(".m-datatable__cell").off("mouseenter", "mouseleave").on("mouseenter", function() {
                        if (o.hoverTimer = setTimeout(function() {
                                o.isScrolling = !1
                            }, 200), !o.isScrolling) {
                ...
                dragResize: function() {
                    var e, a, o = !1,
                        i = void 0;
                    t(n.tableHead).find(".m-datatable__cell").mousedown(function(n) {
                        i = t(this), o = !0, e = n.pageX, a = t(this).width(), t(i).addClass("m-datatable__cell--resizing")
                                ...
                                if (void 0 !== i) {
                                    ...
                                    if (void 0 !== i.selector && !1 !== i.selector) {
                                        ...
                                        var r = t("<label/>").addClass("m-checkbox m-checkbox--single").append(t("<input/>").attr("type", "checkbox").attr("value", l).on("click", function() {
                                            t(this).is(":checked") ? o.setActive(this) : o.setInactive(this)
                                        })).append(t("<span/>"));
                        ...
                        var i = function(a) {
                            ...
                            if (void 0 !== n && void 0 !== n.selector && !1 !== n.selector) {
                                ...
                                var l = t("<label/>").addClass("m-checkbox m-checkbox--single m-checkbox--all").append(t("<input/>").attr("type", "checkbox").on("click", function() {
                                    t(this).is(":checked") ? o.setActiveAll(!0) : o.setActiveAll(!1)
                                })).append(t("<span/>"));
                ...
                setupDOM: function(e) {
                    t(e).find("> thead").addClass("m-datatable__head"), t(e).find("> tbody").addClass("m-datatable__body"), t(e).find("> tfoot").addClass("m-datatable__foot"), t(e).find("tr").addClass("m-datatable__row"), t(e).find("tr > th, tr > td").addClass("m-datatable__cell"), t(e).find("tr > th, tr > td").each(function(e, a) {
                        0 === t(a).find("span").length && t(a).wrapInner(t("<span/>").css("width", o.offset))
                    })
                },
                scrollbar: function() {
                    var i = {
                        ...
                        initDefaultScrollbar: function(e) {
                            t(e).css("overflow", "auto").off().on("scroll", i.onScrolling)
                        },
                        onScrolling: function(e) {
                            var a = t(this).scrollLeft(),
                                n = t(this).scrollTop();
                            t(i.scrollHead).css("left", -a), t(i.scrollFoot).css("left", -a), t(i.tableLocked).each(function(e, a) {
                                t(a).css("top", -n)
                            })
                        },
                        initCustomScrollbar: function(e) {
                            i.scrollable = e, o.initScrollbar(e), t(e).off().on("scroll", i.onScrolling)
                        }
                    };
                    return i.init(), i
                },
                ...
                setHeadTitle: function(i) {
                    ...
                    void 0 === r && (r = document.createElement("tr"), i.appendChild(r)), t.each(l, function(a, o) {
                        var i = s[a];
                        if (void 0 === i && (i = document.createElement("th"), r.appendChild(i)), void 0 !== o.title && (i.innerHTML = o.title, i.setAttribute("data-field", o.field), e.addClass(i, o.class), t(i).data(o)), void 0 !== o.attr && t.each(o.attr, function(t, e) {
                                i.setAttribute(t, e)
                            }), void 0 !== o.textAlign) {
                ...
                updateTableComponents: function() {
                    n.tableHead = t(n.table).children("thead"), n.tableBody = t(n.table).children("tbody"), n.tableFoot = t(n.table).children("tfoot")
                },
                getData: function() {
                    o.spinnerCallback(!0);
                    var e = {
                        ...
                        method: "GET",
                        data: {},
                        timeout: o.getOption("data.source.read.timeout") || 3e4
                    };
                    ...
                    return t.ajax(e).done(function(e, a, i) {
                        n.lastResponse = e, n.dataSet = n.originalDataSet = o.dataMapCallback(e), o.setAutoColumns(), t(n).trigger("m-datatable--on-ajax-done", [n.dataSet])
                    }).fail(function(e, a, i) {
                        t(n).trigger("m-datatable--on-ajax-fail", [e]), t(n.tableBody).html(t("<span/>").addClass("m-datatable--error").html(o.getOption("translate.records.noRecords"))), t(n.wrap).addClass("m-datatable--error m-datatable--loaded"), o.spinnerCallback(!1)
                    }).always(function() {})
                },
                paging: function(a, i) {
                    var l = {
                        ...
                        populate: function() {
                            ...
                            0 == p.length && (p = [10, 20, 30, 50, 100]), t.each(p, function(e, a) {
                                ...
                                t(".selectpicker").selectpicker().siblings(".dropdown-toggle").attr("title", o.getOption("translate.toolbar.pagination.items.default.select"))
                            }), l.paste()
                        },
                        paste: function() {
                            t.each(t.unique(o.getOption("toolbar.placement")), function(e, a) {
                                "bottom" === a && t(l.pager).clone(!0).insertAfter(n.table), "top" === a && t(l.pager).clone(!0).addClass("m-datatable__pager--top").insertBefore(n.table)
                            })
                        },
                        ...
                        openPage: function(e) {
                            l.meta.page = parseInt(e), t(n).trigger(l.paginateEvent, l.meta), l.callback(l, l.meta), t(l.pager).trigger("m-datatable--on-goto-page", l.meta)
                        },
                        updatePerpage: function(e) {
                            e.preventDefault(), l.pager = t(n.table).siblings(".m-datatable__pager").removeClass("m-datatable--paging-loaded"), e.originalEvent && (l.meta.perpage = parseInt(t(this).val())), t(l.pager).find("select.m-datatable__pager-size").val(l.meta.perpage).attr("data-selected", l.meta.perpage), o.setDataSourceParam("pagination", {
                                page: l.meta.page,
                                pages: l.meta.pages,
                                perpage: l.meta.perpage,
                                total: l.meta.total
                            }), t(l.pager).trigger("m-datatable--on-update-perpage", l.meta), t(n).trigger(l.paginateEvent, l.meta), l.callback(l, l.meta), l.updateInfo.call()
                        },
                        addPaginateEvent: function(e) {
                            t(n).off(l.paginateEvent).on(l.paginateEvent, function(e, a) {
                                ...
                                }), t(l.pager).find(".m-datatable__pager-nav").show(), a.pages <= 1 && t(l.pager).find(".m-datatable__pager-nav").hide(), o.setDataSourceParam("pagination", {
                                    page: l.meta.page,
                                    pages: l.meta.pages,
                                    perpage: l.meta.perpage,
                                    total: l.meta.total
                                }), t(l.pager).find("select.m-datatable__pager-size").val(a.perpage).attr("data-selected", a.perpage), t(n.table).find('.m-checkbox > [type="checkbox"]').prop("checked", !1), t(n.table).find(".m-datatable__row--active").removeClass("m-datatable__row--active"), l.updateInfo.call(), l.pagingBreakpoint.call()
                            })
                        },
                        updateInfo: function() {
                            var e = Math.max(l.meta.perpage * (l.meta.page - 1) + 1, 1),
                                a = Math.min(e + l.meta.perpage - 1, l.meta.total);
                            t(l.pager).find(".m-datatable__pager-info").find(".m-datatable__pager-detail").html(o.dataPlaceholder(o.getOption("translate.toolbar.pagination.items.info"), {
                                start: e,
                        ...
                        paginationUpdate: function() {
                            ...
                            t(i).each(function(e, a) {
                                t(i).attr("data-page", p).show()
                ...
                columnHide: function() {
                    ...
                    t.each(a.columns, function(a, i) {
                        if (void 0 !== i.responsive) {
                            var l = i.field,
                                r = t.grep(t(n.table).find(".m-datatable__cell"), function(e, a) {
                ...
                setupSubDatatable: function() {
                    ...
                    if ("function" == typeof e && !(t(n.table).find(".m-datatable__subtable").length > 0)) {
                        ...
                        var i = function(i) {
                                ...
                                t(l).hasClass("m-datatable__row--subtable-expanded") ? (t(c).addClass(o.getOption("layout.icons.rowDetail.collapse")), t(l).removeClass("m-datatable__row--subtable-expanded"), t(n).trigger("m-datatable--on-collapse-subtable", [l])) : (t(c).addClass(o.getOption("layout.icons.rowDetail.expand")), t(l).addClass("m-datatable__row--subtable-expanded"), t(n).trigger("m-datatable--on-expand-subtable", [l])), 0 === t(s).find(".m-datatable").length && (t.map(n.dataSet, function(t, e) {
                                    return d === t[a.columns[0].field] && (i.data = t, !0)
                                }), i.detailCell = s, i.parentRow = l, i.subTable = s, e(i), t(s).children(".m-datatable").on("m-datatable--on-init", function(e) {
                                    t(r).removeClass("m-datatable__row-loading")
                                }), "local" === o.getOption("data.type") && t(r).removeClass("m-datatable__row-loading"))
                            },
                            l = a.columns;
                        t(n.tableBody).find(".m-datatable__row").each(function(e, a) {
                            t(a).find(".m-datatable__cell").each(function(e, a) {
                                var n = t.grep(l, function(e, n) {
                                    return t(a).data("field") === e.field
                                })[0];
                                if (void 0 !== n) {
                                    var r = t(a).text();
                ...
                dataMapCallback: function(t) {
                    var e = t;
                    return "function" == typeof o.getOption("data.source.read.map") ? o.getOption("data.source.read.map")(t) : (void 0 !== t && void 0 !== t.data && (e = t.data), e)
                },
                isSpinning: !1,
                spinnerCallback: function(t) {
                    if (t) {
                        if (!o.isSpinning) {
                            var e = o.getOption("layout.spinner");
                            !0 === e.message && (e.message = o.getOption("translate.records.processing")), o.isSpinning = !0, void 0 !== mApp && mApp.block(n, e)
                        }
                    } else o.isSpinning = !1, void 0 !== mApp && mApp.unblock(n)
                },
                ...
                log: function(t, e) {
                    void 0 === e && (e = ""), n.debug && console.log(t, e)
                },
                autoHide: function() {
                        ...
                        if (t(i).hasClass("m-datatable__row-detail")) t(this).find("i").removeClass(o.getOption("layout.icons.rowDetail.expand")).addClass(o.getOption("layout.icons.rowDetail.collapse")), t(i).remove();
                            ...
                            t(l).each(function() {
                                var e = t(this).data("field"),
                                    n = t.grep(a.columns, function(t, a) {
                                        return e === t.field
                                    })[0];
                    ...
                    t(n.tableBody).find(".m-datatable__row").each(function() {
                        t(this).prepend(t("<td/>").addClass("m-datatable__cell m-datatable__toggle--detail").append(t("<a/>").addClass("m-datatable__toggle-detail").attr("href", "").on("click", e).append(t("<i/>").css("width", "21px").addClass(o.getOption("layout.icons.rowDetail.collapse"))))), 0 === t(n.tableHead).find(".m-datatable__toggle-detail").length ? (t(n.tableHead).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>'), t(n.tableFoot).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>')) : t(n.tableHead).find(".m-datatable__toggle-detail").find("span").css("width", "21px")
                    })
                },
                ...
                setAutoColumns: function() {
                    o.getOption("data.autoColumns") && (t.each(n.dataSet[0], function(e, n) {
                        0 === t.grep(a.columns, function(t, a) {
                            return e === t.field
                        }).length && a.columns.push({
                            field: e,
                            title: e
                        })
                    }), t(n.tableHead).find(".m-datatable__row").remove(), o.setHeadTitle(), o.getOption("layout.footer") && (t(n.tableFoot).find(".m-datatable__row").remove(), o.setHeadTitle(n.tableFoot)))
                },
                isLocked: function() {
                    return e.hasClass(n.wrap[0], "m-datatable--lock") || !1
                },
                ...
                getTableId: function(e) {
                    void 0 === e && (e = "");
                    var a = t(n).attr("id");
                    return void 0 === a && (a = t(n).attr("class").split(" ")[0]), a + e
                },
                getTablePrefix: function(t) {
                    return void 0 !== t && (t = "-" + t), o.getTableId() + "-" + o.getDepth() + t
                },
                getDepth: function() {
                    var e = 0,
                        a = n.table;
                ...
                stateKeep: function(t, e) {
                    t = o.getTablePrefix(t), !1 !== o.getOption("data.saveState") && (o.getOption("data.saveState.webstorage") && localStorage && localStorage.setItem(t, JSON.stringify(e)), o.getOption("data.saveState.cookie") && Cookies.set(t, JSON.stringify(e)))
                },
                stateGet: function(t, e) {
                    if (t = o.getTablePrefix(t), !1 !== o.getOption("data.saveState")) {
                        var a = null;
                        return null != (a = o.getOption("data.saveState.webstorage") && localStorage ? localStorage.getItem(t) : Cookies.get(t)) ? JSON.parse(a) : void 0
                    }
                },
                ...
                stateRemove: function(t) {
                    t = o.getTablePrefix(t), localStorage && localStorage.removeItem(t), Cookies.remove(t)
                },
                getTotalColumns: function(e) {
                    return void 0 === e && (e = n.tableBody), t(e).find(".m-datatable__row").first().find(".m-datatable__cell").length
                },
                ...
                sorting: function() {
                    var e = {
                        init: function() {
                            a.sortable && (t(n.tableHead).find(".m-datatable__cell:not(.m-datatable__cell--check)").addClass("m-datatable__cell--sort").off("click").on("click", e.sortClick), e.setIcon())
                        },
                        setIcon: function() {
                        ...
                        sortClick: function(i) {
                            ...
                            if ((void 0 === s.sortable || !1 !== s.sortable) && (t(n.tableHead).find(".m-datatable__cell > span > i").remove(), a.sortable)) {
                                o.spinnerCallback(!0);
                                var d = "desc";
                                o.getObject("field", l) === r && (d = o.getObject("sort", l)), l = {
                                    field: r,
                                    sort: d = void 0 === d || "desc" === d ? "asc" : "desc"
                                }, o.setDataSourceParam("sort", l), e.setIcon(), setTimeout(function() {
                                    o.dataRender("sort"), t(n).trigger("m-datatable--on-sort", l)
                                }, 300)
                            }
                        }
                    };
                ...
                localDataUpdate: function() {
                    ...
                    if (void 0 !== l && !0 !== o.getOption("data.serverSorting") ? "function" == typeof l.sortCallback ? n.dataSet = l.sortCallback(n.originalDataSet, i, l) : n.dataSet = o.sortCallback(n.originalDataSet, i, l) : n.dataSet = n.originalDataSet, "object" == typeof e.query && !o.getOption("data.serverFiltering")) {
                        ...
                        void 0 !== s && "" !== s && (s = s.toLowerCase(), n.dataSet = t.grep(n.dataSet, r), delete e.query[o.getGeneralSearchKey()]), t.each(e.query, function(t, a) {
                            "" === a && delete e.query[t]
                        }), n.dataSet = o.filterArray(n.dataSet, e.query), n.dataSet = n.dataSet.filter(function() {
                            return !0
                        })
                    }
                    return n.dataSet
                ...
                resetScroll: function() {
                    void 0 === a.detail && 1 === o.getDepth() && (t(n.table).find(".m-datatable__row").css("left", 0), t(n.table).find(".m-datatable__lock").css("top", 0), t(n.tableBody).scrollTop(0))
                },
                getColumnByField: function(e) {
                    var n;
                    if (void 0 !== e) return t.each(a.columns, function(t, a) {
                        if (e === a.field) return n = a, !1
                    }), n
                },
                getDefaultSortColumn: function() {
                    var e;
                    return t.each(a.columns, function(a, n) {
                ...
                getGeneralSearchKey: function() {
                    var e = t(o.getOption("search.input"));
                ...
                rowEvenOdd: function() {
                    t(n.tableBody).find(".m-datatable__row").removeClass("m-datatable__row--even"), t(n.wrap).hasClass("m-datatable--subtable") ? t(n.tableBody).find(".m-datatable__row:not(.m-datatable__row-detail):even").addClass("m-datatable__row--even") : t(n.tableBody).find(".m-datatable__row:nth-child(even)").addClass("m-datatable__row--even")
                },
                timer: 0,
                redraw: function() {
                    return o.adjustCellsWidth.call(), o.isLocked() && (o.scrollbar(), o.resetScroll(), o.adjustCellsHeight.call()), o.adjustLockContainer.call(), o.initHeight.call(), n
                },
                load: function() {
                    return o.reload(), n
                },
                reload: function() {
                    return function(t, e) {
                        clearTimeout(o.timer), o.timer = setTimeout(t, e)
                    }(function() {
                        a.data.serverFiltering || o.localDataUpdate(), o.dataRender(), t(n).trigger("m-datatable--on-reloaded")
                    }, o.getOption("search.delay")), n
                },
                getRecord: function(e) {
                    return void 0 === n.tableBody && (n.tableBody = t(n.table).children("tbody")), t(n.tableBody).find(".m-datatable__cell:first-child").each(function(a, i) {
                        if (e == t(i).text()) {
                            var l = t(i).closest(".m-datatable__row").index() + 1;
                            return n.API.record = n.API.value = o.getOneRow(n.tableBody, l), n
                        }
                    }), n
                },
                getColumn: function(e) {
                    return o.setSelectedRecords(), n.API.value = t(n.API.record).find('[data-field="' + e + '"]'), n
                },
                destroy: function() {
                    t(n).parent().find(".m-datatable__pager").remove();
                    var e = t(n.initialDatatable).addClass("m-datatable--destroyed").show();
                    return t(n).replaceWith(e), t(n = e).trigger("m-datatable--on-destroy"), o.isInit = !1, e = null
                },
                sort: function(e, a) {
                    a = void 0 === a ? "asc" : a, o.spinnerCallback(!0);
                    var i = {
                        field: e,
                        sort: a
                    };
                    return o.setDataSourceParam("sort", i), setTimeout(function() {
                        o.dataRender("sort"), t(n).trigger("m-datatable--on-sort", i), t(n.tableHead).find(".m-datatable__cell > span > i").remove()
                    }, 300), n
                },
                getValue: function() {
                    return t(n.API.value).text()
                },
                ...
                setSelectedRecords: function() {
                    return n.API.record = t(n.tableBody).find(".m-datatable__row--active"), n
                },
                getSelectedRecords: function() {
                    return o.setSelectedRecords(), n.API.record = n.rows(".m-datatable__row--active").nodes(), n.API.record
                },
                getOption: function(t) {
                    return o.getObject(t, a)
                },
                ...
                search: function(e, n) {
                    void 0 !== n && (n = t.makeArray(n)), i = function() {
                        ...
                        "object" == typeof n && (t.each(n, function(t, a) {
                            i[a] = e
                ...
                setDataSourceParam: function(e, a) {
                    n.API.params = t.extend({}, {
                        pagination: {
                            page: 1,
                            perpage: o.getOption("data.pageSize")
                        },
                        sort: o.getDefaultSortColumn(),
                        query: {}
                    }, n.API.params, o.stateGet(o.stateId)), n.API.params = o.extendObj(n.API.params, e, a), o.stateKeep(o.stateId, n.API.params)
                },
                getDataSourceParam: function(e) {
                    return n.API.params = t.extend({}, {
                        pagination: {
                            page: 1,
                            perpage: o.getOption("data.pageSize")
                        },
                        sort: o.getDefaultSortColumn(),
                        query: {}
                    }, n.API.params, o.stateGet(o.stateId)), "string" == typeof e ? o.getObject(e, n.API.params) : n.API.params
                },
                getDataSourceQuery: function() {
                    return o.getDataSourceParam("query") || {}
                },
                setDataSourceQuery: function(t) {
                    o.setDataSourceParam("query", t)
                },
                getCurrentPage: function() {
                    return t(n.table).siblings(".m-datatable__pager").last().find(".m-datatable__pager-nav").find(".m-datatable__pager-link.m-datatable__pager-link--active").data("page") || 1
                },
                getPageSize: function() {
                    return t(n.table).siblings(".m-datatable__pager").last().find("select.m-datatable__pager-size").val() || 10
                },
                getTotalRows: function() {
                    return n.API.params.pagination.total
                },
                getDataSet: function() {
                    return n.originalDataSet
                },
                hideColumn: function(e) {
                    t.map(a.columns, function(t) {
                        return e === t.field && (t.responsive = {
                            hidden: "xl"
                        }), t
                    });
                    var o = t.grep(t(n.table).find(".m-datatable__cell"), function(a, n) {
                ...
                row: function(e) {
                    return o.rows(e), o.nodeTr = o.recentNode = t(o.nodeTr).first(), n
                },
                rows: function(e) {
                    return o.nodeTr = o.recentNode = t(n.tableBody).find(e).filter(".m-datatable__row"), n
                },
                column: function(e) {
                    return o.nodeCols = o.recentNode = t(n.tableBody).find(".m-datatable__cell:nth-child(" + (e + 1) + ")"), n
                },
                columns: function(e) {
                    var a = n.table;
                ...
                cell: function(e) {
                    return o.cells(e), o.nodeTd = o.recentNode = t(o.nodeTd).first(), n
                },
                cells: function(e) {
                    var a = t(n.tableBody).find(".m-datatable__cell");
                    return void 0 !== e && (a = t(a).filter(e)), o.nodeTd = o.recentNode = a, n
                },
                remove: function() {
                    return t(o.nodeTr.length) && o.nodeTr === o.recentNode && t(o.nodeTr).remove(), o.layoutUpdate(), n
                },
                visible: function(e) {
                    if (t(o.recentNode.length)) {
                        ...
                        e ? (o.recentNode === o.nodeCols && delete a.columns[i].responsive, t(o.recentNode).show()) : (o.recentNode === o.nodeCols && o.setOption("columns." + i + ".responsive", {
                            hidden: "xl"
                        }), t(o.recentNode).hide()), o.redraw()
                    }
                },
                nodes: function() {
                    return o.recentNode
            ...
            if (t.each(o, function(t, e) {
                ...
                } else n.data("mDatatable") || t(this).hasClass("m-datatable--loaded") || (n.dataSet = null, n.textAlign = {
                    left: "m-datatable__cell--left",
                    center: "m-datatable__cell--center",
                    right: "m-datatable__cell--right"
                }, a = t.extend(!0, {}, t.fn.mDatatable.defaults, a), n.options = a, o.init.apply(this, [a]), t(n.wrap).data("mDatatable", n));
...
return {
    ...
    initAside: function() {
        var n, l, r, s, d, c, m, u;
        r = mUtil.get("body"), s = mUtil.get("m_aside_left"), d = mUtil.hasClass(s, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", a = new mOffcanvas("m_aside_left", {
            baseClass: d,
            overlay: !0,
        ...
        }), mUtil.hasClass(r, "m-aside-left--fixed") && (mUtil.addEvent(s, "mouseenter", function() {
            l && (clearTimeout(l), l = null), n = setTimeout(function() {
                mUtil.hasClass(r, "m-aside-left--minimize") && mUtil.isInResponsiveRange("desktop") && (mUtil.removeClass(r, "m-aside-left--minimize"), mUtil.addClass(r, "m-aside-left--minimize-hover"), e.scrollerUpdate(), e.scrollerTop())
            }, 300)
        }), mUtil.addEvent(s, "mouseleave", function() {
            n && (clearTimeout(n), n = null), l = setTimeout(function() {
                mUtil.hasClass(r, "m-aside-left--minimize-hover") && mUtil.isInResponsiveRange("desktop") && (mUtil.removeClass(r, "m-aside-left--minimize-hover"), mUtil.addClass(r, "m-aside-left--minimize"), e.scrollerUpdate(), e.scrollerTop())
            }, 500)
        })), m = mUtil.get("m_ver_menu"), u = "1" === mUtil.attr(m, "m-menu-dropdown") ? "dropdown" : "accordion", "1" === mUtil.attr(m, "m-menu-scrollable") && (c = {
            height: function() {
